...
<div class="container-fluid py-5 container-service" id="service-body-massage">
	...
	<div class="container py-4">
		...
		<div class="row  align-items-center" style="padding-top: 4rem;">
			<div class="col-lg-6">
...
<div class="container-fluid py-5 container-service" id="partial-massage">
...
<div class="container-fluid py-5 container-service" id="head-spa-massage">
...
<div class="container-fluid py-5 container-service" id="packages-massage">
...
<div class="container-fluid py-5 container-service" id="booking-service">
	<div class="container py-5">
		...
		<div class="mx-auto text-center mb-5 title-service" style="max-width: 930px;margin-top: 100px;">
